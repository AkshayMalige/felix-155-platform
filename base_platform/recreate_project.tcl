...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/src/ext_platform_part.bd"]"\
 "[file normalize "$origin_dir/src/pinout.xdc"]"\
 "[file normalize "$origin_dir/src/ext_platform_part_wrapper.v"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "flx_base_platform"
...
set orig_proj_dir "[file normalize "$origin_dir/../base_platform/flx_base_platform"]"
...
# Create project
create_project ${_xil_proj_name_} "./project_build" -part xcvp1552-vsva3340-2MHP-e-S
...
set_property -name "part" -value "xcvp1552-vsva3340-2MHP-e-S" -objects $obj
...
set_property -name "platform.num_compute_units" -value "15" -objects $obj
...
set file "$origin_dir/src/ext_platform_part.bd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "pfm_name" -value "xilinx:board:name:0.0" -objects $file_obj
...
set_property -name "top" -value "ext_platform_part_wrapper" -objects $obj
...
set file "[file normalize ${origin_dir}/src/pinout.xdc]"
add_files -norecurse -fileset constrs_1 $file
set file "src/pinout.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Set 'constrs_1' fileset properties
set obj [get_filesets constrs_1]
set_property -name "target_part" -value "xcvp1552-vsva3340-2MHP-e-S" -objects $obj
...
set_property -name "xsim.simulate.xsim.more_options" -value "-gui" -objects $obj

# Set 'utils_1' fileset object
set obj [get_filesets utils_1]
# Import local files from the original project
# No utils files to add
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xcvp1552-vsva3340-2MHP-e-S -flow {Vivado Synthesis 2025} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xcvp1552-vsva3340-2MHP-e-S -flow {Vivado Advanced Implementation 2025} -strategy "Vivado Advanced Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
